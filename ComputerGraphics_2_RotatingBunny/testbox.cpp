...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        ourShader.setMat4("m", model);
        glm::mat3 inverseTransposeM = model;
        ourShader.setMat3("m_3x3_inv_transp", inverseTransposeM);
        
        glm::mat4 mvp = projection * view * model;
        ourShader.setMat4("mvp", mvp);

            //glm::mat4 invT[0ransMat = glm::transpose(glm::inverse(mvp));
        //ourShader.setMat4("")
